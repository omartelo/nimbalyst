...
Whenever an architectural change or decision is made — whether proposed by the human or the AI — create an Excalidraw diagram to visualize it and show it to the user inline. Apply this to decisions like:
